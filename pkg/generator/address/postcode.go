...
// postcodeUK returns a random string that matches the format of a UK post code:
// XX1 1XX or XX11 1XX
//
// Where:
...
// postcodeUS returns a random string that matches the format of a US zipcode:
// 11111
//
// Where:
// 1 is a random number between [1, 9]
